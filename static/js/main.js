// Main JavaScript functionality for InterviewBuddy
...
function initializeApp() {
    ...
    console.log('InterviewBuddy initialized');
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  toggle.addEventListener("click", () => {
    ...
    if (window.InterviewBuddyCharts.length > 0) {
      window.InterviewBuddyCharts.forEach(chart => {
